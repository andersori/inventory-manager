...
import io.github.andersori.core.usecases.variables.unique.FindTestAccount
...
class FindTestAccountTest {
    ...
    private fun testFakeAccount(id: Account) = runTest {
    ...
    @Test
    fun `nao eh conta de test`() = runTest {
        val id = Account(
            id = UUID.randomUUID().toString(),
            name = "temp",
            active = true
