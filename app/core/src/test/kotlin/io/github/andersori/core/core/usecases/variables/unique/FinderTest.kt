...
class FinderTest {
    ...
    fun testHandlerWithThrowErrorOnNextHandler() = runTest {
        ...
        verify(
            logger,
            times(1)
        ).error("io.github.andersori.core.core.usecases.variables.unique.FinderTest\$testHandlerWithThrowErrorOnNextHandler\$1\$finder2\$1\$execute\$2 - Testing")
    }
    ...
    fun testHandlerWithoutOtherHandlersNotIgnoringEx() = runTest {
        ...
        verify(
            logger,
            times(1)
        ).error("io.github.andersori.core.core.usecases.variables.unique.FinderTest\$testHandlerWithoutOtherHandlersNotIgnoringEx\$1\$finder\$1\$execute\$2 - Testing")
    }
    ...
    fun testHandlerWithoutOtherHandlersIgnoringEx() = runTest {
        ...
        verify(
            logger,
            times(1)
        ).error("io.github.andersori.core.core.usecases.variables.unique.FinderTest\$testHandlerWithoutOtherHandlersIgnoringEx\$1\$finder\$1\$execute\$2 - Testing")
    }
}